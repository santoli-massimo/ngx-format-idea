...
public class NgxComponentStartImpl extends ASTWrapperPsiElement implements NgxComponentStart {

  public NgxComponentStartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NgxVisitor visitor) {
    visitor.visitComponentStart(this);
  }
