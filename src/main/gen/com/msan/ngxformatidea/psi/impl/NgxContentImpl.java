...
public class NgxContentImpl extends ASTWrapperPsiElement implements NgxContent {

  public NgxContentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<NgxText> getTextList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NgxText.class);
  }
