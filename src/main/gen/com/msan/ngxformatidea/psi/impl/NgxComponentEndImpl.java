...
public class NgxComponentEndImpl extends ASTWrapperPsiElement implements NgxComponentEnd {

  public NgxComponentEndImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NgxVisitor visitor) {
    visitor.visitComponentEnd(this);
  }
